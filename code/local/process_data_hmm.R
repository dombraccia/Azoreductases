...
# if(file.exists("data/m2_data.RDS")) {
#   m2_data <- readRDS("data/m2_data.RDS")
# } else {
#   tic()
#   m2_data <- curatedMetagenomicData(pattern = "*relative_abundance*", dryrun = FALSE)
#   saveRDS(m2_data, file = "data/m2_data.RDS")
#   toc()
# }
